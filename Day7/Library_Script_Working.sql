drop database if exists librarymphasis;

create database librarymphasis;
...
Insert into LibUsers values('Mythri','Mythri'),('Vamsi','Krishna'),
('Shiva','Pallavi'),('Srinivas','Srinivas');

CREATE TABLE TranBook(
        tbId INT Primary Key AUTO_INCREMENT,
