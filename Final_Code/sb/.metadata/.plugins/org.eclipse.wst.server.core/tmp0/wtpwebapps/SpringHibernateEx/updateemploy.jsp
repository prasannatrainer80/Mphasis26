...
<form method="post" action="updateemploy.jsp">
	<center>
		...
		<input type="number" name="empno" readonly 
				value=${employ.empno} /> <br/><br/>
		Employ Name : 
		<input type="text" name="name" 
			value=${employ.name} /> <br/><br/>
		Gender : 
		<input type="text" name="gender" 
			value=${employ.gender} /> <br/><br/>
		Department : 
		<input type="text" name="dept" 
			value=${employ.dept} /> <br/><br/>
		Designation : 
		<input type="text" name="desig" 
			value=${employ.desig} /> <br/><br/>
		Basic : 
		<input type="number" name="basic" 
			value=${employ.basic} /> <br/><br/>
...
<c:if test="${param.empno !=null && param.basic!=null}">
	...
	<c:out value="${dao.updateEmploy(employUpdate)}" />
